...
final class LiveTextInserter {
    ...
    func replace(with text: String) -> Bool {
        ...
        // Accessibility objects in Electron editors and terminal surfaces can
        // be recreated while their app and visible caret stay unchanged. Keep
        // the dependable process boundary used by the compatibility paste.
        guard targetPID == 0
