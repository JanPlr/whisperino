...
echo ""
echo "    NOTE: setup.sh installs the speech engine only."
echo "          It does NOT install or launch Whisperino.app."
echo ""
echo "    Next: Run ./install.sh to build, install, and launch"
echo "          the exact /Applications/Whisperino.app that"
echo "          must receive Accessibility permission."
